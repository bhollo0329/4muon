...
h1 = TH1D('h1', 'Ratio Cos(Helicity) 988016', 30, -1.5, 1.5)
h2 = TH1D('h2', 'Tetraquark pT (988016)', 100, 0, 100)
h3 = TH1D('h3', ' ', 30, -1.5, 1.5)
h4 = TH1D('h4', 'Cos(Helicity) 988016 Parent pT Cut Ratio', 30, -1.5, 1.5)
sc = TH2F('sc', 'Cos(Helicity) v. Mu+-Tetraquark pT Average (988016)', 20, -1.5, 1.5, 30, -10, 4)
scE = TH2F('scE', 'Cos(Helicity) v. Mu+ Pseudorapidity (988016)', 20, -1, 1, 30, -4, 4)
scU = TH2F('scU', 'Cos(Helicity) v. (Mu+ - Upsilon pT)/2 (988016)', 20, -1, 1, 40, -8, 3)
pro = TProfile('hpro', 'Cos(Helicity) v. Muon+-Tetraquark pT Average Profile (988016)', 20, -1.5, 1.5)
pro1 = TProfile('hpro1', 'Cos(Helicity) v. Muon+-(Upsilon pT/2) Profile (988016)', 20, -1, 1)
pro2 = TProfile('hpro2', 'Cos(Helicity) v. Muon+ Pseudorapidity Profile (988016)', 20, -1, 1)

path = 'root://eosatlas.cern.ch//eos/atlas/user/d/daits/mc16_13TeV/recon/mc16.988016.MGPy8EG_23lo_P4b18p4NP01_Upsi1S2mu_4mu.merge.AOD.e8304_a875_r10724_r10726_pUM999999/'

filelist = [path+'merge.AOD.988016._00001.pool.root.1', path+'merge.AOD.988016._00002.pool.root.1', path+'merge.AOD.988016._00003.pool.root.1', path+'merge.AOD.988016._00004.pool.root.1', path+'merge.AOD.988016._00005.pool.root.1', path+'merge.AOD.988016._00006.pool.root.1', path+'merge.AOD.988016._00007.pool.root.1', path+'merge.AOD.988016._00008.pool.root.1', path+'merge.AOD.988016._00009.pool.root.1']

fer = open('runevnt016.txt', 'r')
run_evnt_set = set()
