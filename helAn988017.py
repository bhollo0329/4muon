...
h1 = TH1D('h1', 'Ratio Cos(Helicity) 988017', 30, -1.5, 1.5)
h2 = TH1D('h2', 'Tetraquark pT (988017)', 100, 0, 100)
h3 = TH1D('h3', ' ', 30, -1.5, 1.5)
h4 = TH1D('h4', 'Cos(Helicity) 988017 Parent pT Cut Ratio', 30, -1.5, 1.5)
sc = TH2F('sc', 'Cos(Helicity) v. Mu+ - Tetraquark pT Average (988017)', 20, -1.5, 1.5, 30, -10, 4)
scU = TH2F('scU', 'Cos(Helicity) v. (Mu+ - Upsilon pT)/2 (988017)', 20, -1, 1, 40, -8, 3)
scE = TH2F('scE', 'Cos(Helicity) v. Mu+ Pseudorapidity (988017)', 20, -1, 1, 30, -4, 4)
pro = TProfile('hpro', 'Cos(Helicity) v. Muon+-Tetraquark pT Average Profile (988017)', 20, -1, 1)
pro1 = TProfile('hpro', 'Cos(Helicity) v. Muon+-(Upsilon pT/2) Relativistic Profile (988017)', 20, -1, 1)
pro2 = TProfile('hpro2', 'Cos(Helicity) v. Muon+ Pseudorapidity Profile (988017)', 20, -1, 1)
...
for f in filelist:
    ...
    for evnt in xrange(nEntries):
        ...
        if ptU > 10:
            scU.Fill(coshel(muon, Upsi, Tetra), (ptM-ptU1)/2)
